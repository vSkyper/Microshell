...
void help() {
    ...
    printf(YELLOW "\nCommands:" COLOR_RESET "\n>> exit\n>> help\n>> cd\n>> mv\n>> mkdir: flags: -v, -p, -vp/-pv\n>>Commands that refer by name to programs located in directories described by the value of the PATH environment variable, and allow these scripts and programs to be called with arguments\n>> Support for quotation marks: \"...\"\n");
}

void cd(char *StringArray[BUFFER_SIZE], char prev_directory_main[BUFFER_SIZE], char prev_directory_secondary[BUFFER_SIZE]) {
